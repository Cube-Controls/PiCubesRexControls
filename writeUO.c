/************************************************************
*
* REXLANG - Using the PiCube UOs via I2C
*
*************************************************************/
...
long input(2) output_type;     // Digital Ouptut Type
long input(3) output_value;    // Digital Ouptut Value
...
long main(void)
{
    ...
    i2c_bufTx[1] = output_type;
	i2c_bufTx[2] = output_value;
    i2c_write_count = 3;
    i2c_read_count = 0;
